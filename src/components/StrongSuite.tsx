      ...
      <div className="max-w-6xl mx-auto">
            ...
            >
              {services.map((service, index) => (
                <div key={index} className="w-full flex-shrink-0 px-2 sm:px-4">
                  <Card key={index} className="border-2 sm:border-4 border-gray-200 hover:border-gray-900 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 sm:hover:-translate-y-3 bg-white mx-auto max-w-md">
        ...
        <div className="bg-white border border-gray-200 sm:border-2 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 mb-8 sm:mb-12 lg:mb-16 transition-colors duration-300">
          <div className="text-center mb-6 sm:mb-8">
            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-4">Technology Stack</h3>
